...
#define DRV_MODULE_VERSION	"1.52.15"
#define DRV_MODULE_RELDATE	"$DateTime: 2010/04/11 03:59:59 $"
...
#ifndef BNX2X_UPSTREAM /* ! BNX2X_UPSTREAM */
#if (LINUX_VERSION_CODE >= 0x020600)
MODULE_INFO(cvs_version, "$Revision: #6 $");
#endif
#endif
...
#if defined(NETIF_F_GRO) && !defined(BCM_DISABLE_GRO) /* BNX2X_UPSTREAM */
